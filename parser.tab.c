...
#line 166 "parser.y"
		...
		ver_simbolo_por_pantalla(nuevo_simbolo(tabla_simbolos, (yyvsp[-3].strval), VARIABLE, tipo_variable));
...
#line 187 "parser.y"
                                                {
        ver_simbolo_por_pantalla(nuevo_simbolo(tabla_simbolos, (yyvsp[-2].strval), VARIABLE, (yyvsp[0].intval)));
        (yyval.intval) = (yyvsp[0].intval);
        printf("%s ", (yyvsp[-2].strval));
        printf("%d ", (yyval.intval));
        }
